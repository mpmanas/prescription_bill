...
<body>
            ...
            include_once 'classes/prescription_header.php';
	            $update= new admin();
	            $inv_id = $_GET['Inv_Id'];
	            $d1 = $update->getPatientDetailsFromInvoice($inv_id, $chamber_name, $doc_name);
           ...
           <!-- End Patient Details -->
            ...
            <div class="invest_rx"><div class="headings"><!--<img src="images/Briefcase-Medical.png" />-->&nbsp;Rx (Prescription)</div>    
                <div class="col-xs-12 .col-sm-6 .col-lg-8">      
                    ...
                    <?php
                        $q11 = "SELECT * FROM patient_proc a WHERE a.row_id = '$inv_id'";
                            //echo $q5;
                            ...
                            <tr>
                                <td class='medicine_desc'>
                                    ...
                                    <img src="images/arrow-right.png" />
                                        ...
                                        <td><?php echo $rs['proc_charge'] - $rs['discount'] ?></td>
